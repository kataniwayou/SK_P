...
| Service resource attributes from config (`service.name`, `service.version`) | PROJECT.md locked: `steps-api` / `3.2.0` | LOW | `ResourceBuilder.CreateDefault().AddService(serviceName: cfg["Service:Name"], serviceVersion: cfg["Service:Version"])`. |
