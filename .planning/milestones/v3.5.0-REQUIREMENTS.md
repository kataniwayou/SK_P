...
> **ARCHIVED 2026-06-05.** Snapshot of the milestone-scoped requirements for v3.5.0
> (Processor Console — phases 25-30). This file was the active `.planning/REQUIREMENTS.md`
> until the v3.6.0 close, at which point it was archived here under its correct version name
> (it had never been rolled forward to v3.6.0). All requirements below shipped — see the
> v3.5.0 phase rows in `ROADMAP.md` (all Complete, 2026-06-01 → 2026-06-02). Note: v3.5.0's
> full ROADMAP archive / MILESTONES entry / git tag were deliberately deferred at the v3.6.0
> close (scope was limited to v3.6.0); this requirements snapshot is the one piece captured.
