...
/// <summary>
/// Bus-wide inbound consume filter (CORR-01, amended D-01). Reads the correlation id from the
/// message BODY (<c>context.Message as ICorrelated</c>), falling back to the MassTransit envelope
/// then a fresh Guid, publishes it into the ambient <see cref="ICorrelationAccessor"/>, and opens a MEL
